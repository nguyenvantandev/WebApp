package co.jp.myapp.model;

public class TestTrainingVal {
	...
	public String getResultAnwser() {
		return resultAnwser;
	}
	public void setResultAnwser(String resultAnwser) {
		this.resultAnwser = resultAnwser;
	}
